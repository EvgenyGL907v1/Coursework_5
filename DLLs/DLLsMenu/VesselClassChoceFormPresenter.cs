...
namespace Menus
{
	public class VesselClassChoiceFormPresenter : ChoiceFormPresenter
	{
		...
		public VesselClassChoiceFormPresenter()
		{
		...
		public override void TableInit()
		{
			...
			List<TableColumn> columns = new List<TableColumn>()
			{
				...
				new TableColumn("Class", "Название", TableColumnType.TEXT)
			};
		...
		{
			base.TableLoad(obj);
			_items = _referencesManager.GetClassesList();
